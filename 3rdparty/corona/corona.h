...
#include <stddef.h>
#include <string>
#include <string.h> // kevin:  memcpy in gcc/cygwin
...
namespace corona {
  ...
  public:
     ...
     * @return  image width
     */
    virtual int COR_CALL getWidth() const = 0;

    /**
     * Get image height.
     * @return  image height
     */
    virtual int COR_CALL getHeight() const = 0;

    /**
     * Get pixel format.
     * @return  pixel format
     */
    virtual PixelFormat COR_CALL getFormat() const = 0;
     ...
     */
    virtual void* COR_CALL getPixels() const = 0;
